...
| Integer value                      | Name                                                            |   new     |
| ------------------------- | -------------------------------------------------------------------- | -----------------|
| 0      | Standard Input       | no |
| `1-create_file.c`         | `int create_file(const char *filename, char *text_content);`         |   no |
| `2-append_text_to_file.c` | `int append_text_to_file(const char *filename, char *text_content);` | no|
